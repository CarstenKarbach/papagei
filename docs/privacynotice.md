<h1> Datenschutzerklärung Hömma</h1>
...
<h3>Übersicht</h3>
    <p>
        Hömma ist eine Anwendung zum Abspielen und Aufnehmen von Sounds. Diese können sortiert, durchsucht und mit Tags versehen werden.
        Man kann sich eigene Ansichten von Sounds zusammenstellen und diese abspielen lassen.
        Es werden keine Anmeldedaten oder sonstige persönliche Daten zur Nutzung benötigt. Die Sounds und deren Metadaten werden ausschließlich
        ...
        Sounds an von Ihnen ausgewählte Empfänger weitergeben. Bei Löschung der Anwendung werden alle zugehörigen Sounds und Metadaten ebenfalls gelöscht.
    </p>

<h3 id="dsg-general-datatype">Arten der verarbeiteten Daten</h3><p>
-	Tonaufnahmen, Metadaten zu den Tönen und Sortierung.<br></p><h3 id="dsg-general-datasubjects">Kategorien betroffener Personen</h3><p>Nutzer des Appangebotes (Nachfolgend bezeichnen wir die betroffenen Personen zusammenfassend auch als „Nutzer“).<br>
